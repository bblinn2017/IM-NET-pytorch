...
parser.add_argument("--dataset", action="store", dest="dataset", default="03001627_vox256_img", help="The name of dataset")
...
parser.add_argument("--load_checkpoint", action='store_true', dest='load_checkpoint', default=False)
parser.add_argument("--data_dir", action="store", dest="data_dir", default="data/03001627_chair//", help="Root directory of dataset [data]")
...
parser.add_argument("--load_data", action='store_true', dest='load_data', default=False)
FLAGS = parser.parse_args()
FLAGS.dataset_load = 'train_z' if FLAGS.train else 'test'
